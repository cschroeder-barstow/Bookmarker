...
exportButton.addEventListener("click", () => {
  ...
  download.download = "gdev-bookmarks.json";
  download.click();
...
form.addEventListener("submit", (event) => {
  ...
  if (temporaryCheckbox.checked) bookmarks[bookmarks.length - 1].tags.unshift("Temp");
  saveBookmarks();
  selectedCategory = "all";
  renderCategories();
  renderBookmarks();
